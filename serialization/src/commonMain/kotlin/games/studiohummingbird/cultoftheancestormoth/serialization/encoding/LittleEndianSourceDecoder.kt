/**
Cult of the Ancestor Moth (LittleEndianSourceDecoder.kt)
...
class LittleEndianSourceDecoder(private val source: Source) : AbstractDecoder() {
    override val serializersModule: SerializersModule = EmptySerializersModule()

    // maybe passed in somehow?
