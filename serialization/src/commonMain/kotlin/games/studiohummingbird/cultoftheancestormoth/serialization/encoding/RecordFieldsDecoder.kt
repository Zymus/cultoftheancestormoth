...
class RecordFieldsDecoder(
    override val serializersModule: SerializersModule,
    private val source: Source,
) : AbstractDecoder() {

    private var elementIndex = 0
    private lateinit var header: RecordHeader
    private lateinit var value: RecordValue
    ...
    override fun <T> decodeSerializableElement(
        ...
        when (index) {
            ...
            1 -> PluginFormat.decodeFromSource(Fields.serializer(), source)
