/**
Cult of the Ancestor Moth (TypeTagCompositeDecoder.kt)
...
fun interface TypeTagCompositeDecoder {
    fun decodeTypeTagElement(descriptor: SerialDescriptor, index: Int): TypeTag
}
